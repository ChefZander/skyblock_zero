return {
    {
        type = "text",
        title = "Questline: Sensors",
        text = "Multi-step processes just to craft some logic gates? Yes please!"
    },
    {
        type = "quest",
        title = "Sensor Linker",
...
Press <b>aux1+any click/tap</b> with the sensor tool, on a sensor, to link that tool to the sensor.
Then, you can <b>right click</b> with the tool on a sensor, and set the name of the link (usually "A" or "B").
You can <b>left click</b> with the tool on a sensor, and automatically use the name you got from <b>right clicking</b>.
When you <b>left click</b> a node that is already link, it will un-link it.
]],
