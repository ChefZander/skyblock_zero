...
Mostly right now this is just a means of clear organization between stuff
we need to be super clear on the license for (not in this mod) and stuff that's
free and clear of copyright issues, which would be foley recorded and edited personally (by AbbyRead only at this time),
text-to-speech generated via formant synthesis, generated waveforms, or layered mixes
of the above.  There's also now a folder for the older sound assets we were using: `licensed`.
