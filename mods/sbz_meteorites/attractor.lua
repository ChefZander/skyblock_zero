        ...
        if not obj:is_player() and obj:get_luaentity().name == "sbz_meteorites:meteorite" then
            ...
            if elapsed > 1 then
                minetest.add_particlespawner({
                    ...
                    texture = "meteorite_trail_emitter.png"..(t < 0 and "^[colorize:#ffcccc:alpha" or "^[colorize:#888888:alpha"),
...
minetest.register_entity("sbz_meteorites:gravitational_attractor_entity", {
    ...
    on_activate = function (self)
        ...
        if node == "sbz_meteorites:gravitational_attractor" then self.type = 1
        elseif node == "sbz_meteorites:gravitational_repulsor" then self.type = -1
    ...
    on_step = function (self, dtime)
        ...
        if node ~= "sbz_meteorites:gravitational_attractor" and node ~= "sbz_meteorites:gravitational_repulsor" then self.object:remove() end
