...
minetest.register_node("sbz_meteorites:gravitational_repulsor", {
    ...
    inventory_image = "gravitational_attractor.png^(([combine:32x32:8,8=neutronium.png)^[invert:rgb^[resize:16x16)",
    wield_image = "gravitational_attractor.png^(([combine:32x32:8,8=neutronium.png)^[invert:rgb^[resize:16x16)",
    paramtype = "light",
    sunlight_propagates = true,
    light_source = 7,
