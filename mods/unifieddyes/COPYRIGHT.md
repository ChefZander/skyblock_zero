...
Original mod. <https://github.com/mt-mods/unifieddyes>
- Copyright (C) 2012-2021 Vanessa Dannenberg. GPL-2.0-or-later.
...
`textures/color_tool.png` Copyright (C) 2024 TheEt1234. CC BY-SA 4.0.

`textures/colorium.png` Copyright (C) 2024 TheEt1234. CC BY-SA 4.0.

`textures/colorium_ground_line_crossing.png` Copyright (C) 2025 TheEt1234. CC BY-SA 4.0.

`textures/colorium_ground_line_curved.png` Copyright (C) 2025 TheEt1234. CC BY-SA 4.0.
...
`textures/unifieddyes_palette_colorwallmounted.png` color palette by Vanessa Dannenberg.

`textures/unifieddyes_palette_extended.png` color palette by Vanessa Dannenberg.