--[=[
This file is part of screwdriver mod.

Original mod.
Copyright (C) 2013-2022 Original screwdriver Mod Contributors

Modifications for Skyblock: Zero.
Copyright (C) 2024-2025 Skyblock: Zero screwdriver Mod Contributors
...
-- simplified version of core:builtin/game/falling.lua#L148.
...
do -- Screwdriver recipe scope
    local Screwdriver = 'screwdriver:screwdriver'
